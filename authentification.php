            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
								...
								<li><a href="recherche.php">Louer</a></li>
								<li><a href="#" class="scroll-link" data-id="about">Panier</a></li>
								<li><a href="#" class="scroll-link" data-id="portfolio">Messagerie</a></li>
            ...
            <li class="selected first-slide">
                <div class="cd-full-width">
                    <div class="tm-slide-content-div slide-caption">
                        ...
                        <div class="primary-button Style1">veuillez vous inscrire </div>                           
                    </div> 
  <form id="form1" name="form1" method="post" action="connexio.php">                  
<table width="946" height="121" border="0" align="right">
                     
                      <tr>
                        <td><span class="Style2">Identifiant</span></td>
                        <td><input name="id" type="text" id="id"></td>
                      </tr>
                      <tr>
                        <td height="22"><span class="Style2">Mot de passe : </span></td>
                        <td><input name="password" type="password" id="password"></td>
                      </tr>
                      <tr>
                        <td height="24">&nbsp;</td>
                        <td><input name="Submit22" type="submit" class="Style2" value="Envoyer">
                        <input name="Submit222" type="reset" class="Style2" value="Annuler"></td>
                      </tr>
    </table>
    <p>&nbsp;</p>
              </form>
                    ...
                    <div class="blog-item b1">
                        <div class="thumb">
                            ...
                            <div class="text-content">
                                ...
                                <span>Posted: <em>George</em>  /  Date: <em>11 Aug 2017</em>  /  Category: <em>Design</em></span>                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="blog-item second-blog b2">
                        <div class="thumb">
                            ...
                            <div class="text-content">
                                ...
                                <span>Posted: <em>Kerley</em>  /  Date: <em>24 Jul 2017</em>  /  Category: <em>Artwork</em></span>                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="blog-item b3">
                        <div class="thumb">
                            ...
                            <div class="text-content">
                                ...
                                <span>Posted: <em>Johnny</em>  /  Date: <em>16 Jul 2017</em>  /  Category: <em>Branding</em></span>                            </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="social-icons">
                        <ul>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-rss"></i></a>                            </li>
                            <li>
